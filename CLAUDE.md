...
- `.agents/claude.md` – Projekt-Anweisungen für Claude Code
...
4. `claude.md` **nie** automatisch ändern – das ist eine bewusste Nutzer-Entscheidung.
...
### Template `.agents/claude.md` (minimal, aber alles Wichtige)
